...
<head>
  <meta charset="UTF-8">
  <title>Menu Barolo</title>
  <link href="https://fonts.googleapis.com/css?family=Libre+Baskerville:400,400i" rel="stylesheet">

  <link rel="stylesheet" href="../web/css/reset.min.css"/>
  <link rel="stylesheet" href="../web/css/menu.css"/>
  <link rel='stylesheet prefetch' href='https://use.typekit.net/qtp1vvq.css'>
<link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/tachyons/4.9.1/tachyons.min.css'>
...
">
		...
		<a class="f8 lh-copy" href="restaurante.php">Visita el sitio web</a>
	</div>
	<div class="logo center pb4 tc">  
    <img class="w-70 w-50-bp1 w-40-bp3" src="http://i67.tinypic.com/25hjrqd.png"> 
  </div>
	<div class="atf bdb-bp1 pt2 pb3 flex justify-between">
		<div class="pb1">
			<h2 class="script f4 pt3">Los mejores platillos</h2>
			
		</div>
		<div class="tr pb1">
			<h2 class="script f4 pt3">La mejor atencion</h2>
			
		</div>
	</div>
  <div class="advert ad--trout">
		<img class="wide-icon" src="http://i66.tinypic.com/os4itk.png">
		<h4 class="din f7 ttu tracked pb2">Proveedor Cosenza Importaciones</h4>
		<p class="f8 lh-copy" href="">Visita el sitio web</p>
    </div>
	...
	<div class="items--container lunch--container">
		...
		<div class="providers tc pv3 bdb bdt bdr bdl mt3">
			<h3 class="script f3 mb0 pt3">Disfruta de nuestro menu</h3>
			<h3 class="cubano f3 tracked green pb3 nt1">Y ten una experiencia Barolo</h3>
			<h3 class="script f3">Con el paladin de la hospitalidad</h3>
		</div>
	</div>
