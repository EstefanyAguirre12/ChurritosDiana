...
$header = array( 'Nombre','Cantidad','Color','Categoria'); 

//le asignamos margenes a la pagina
$fpdf->setMargins(1.1,1.1,1.1);
$fpdf->setTitle('Material');
...
$data=$material->GetReporteMaterial($_GET['idmaterial']);
$nombre=$material->getMaterial22($_GET['idmaterial']);
$fpdf->AddPage();  
$fpdf->titulo($nombre);  
if($data!=null){ 
$fpdf->Ln(1);
