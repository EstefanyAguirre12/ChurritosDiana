...
{ //posicion 
    ...
    // Arial
    $this->SetFont('Arial','B',14); 
    $this->Cell(0,0.9,'Reservas habitaciones barolo',0,2,'C',false);
    // Page number
...
$header = array( 'Nombre cliente','N habitacion','Fecha inicio','Fecha fin','Hora inicio','Hora fin'); 
...
$data=$Detallereserva->GetReporteReservaHabitacion($_GET['f1'], $_GET['f2']);
