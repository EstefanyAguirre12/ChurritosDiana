								...
								if($object->checkClaveUsuario()){
									...
									if($date1>=$date2){
										...
										if($diferenciaDias>=90){
											# necesita cambiar la contrase̱a
											Page::showMessage(3, "Por razones de seguridad usted tiene que cambiar su contrase̱a (cada 90 dias)", "clave90dias.php");
										}else{
														...
														if($modificarNum){
															...
															if($Id_estado==0){
																...
																if($object->setestado_sesion($sumaEstadoSesion)){
																	...
																	#	redireccionar al menu normalmente pero tiene que cambiar su contrase̱a en: ".$diasRestantes." dias
																	$diasRestantes=90 - $diferenciaDias;
																	Page::showMessage(1, "Inicio de sesion correcto (Por razones de seguridad usted tiene que cambiar su contrase̱a en ".$diasRestantes." dias)", "index.php");
																}
															}else if($Id_estado==1){
																$sumaEstadoSesion=$Id_estado+1;
																if($object->setestado_sesion($sumaEstadoSesion)){
																...
																throw new Exception("Por motivos de seguridad este usuario a sido suspendido, revisar correo electronico con las instrucciones a seguir(recupera tu contrase̱a para verificar tu identidad)","correo.php");
															}
														}
													}else{
