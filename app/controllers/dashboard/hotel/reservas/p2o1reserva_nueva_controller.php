							...
							if($dato->setIdtipo($_POST['tip'])){
								if($dato->setIdgenero($_POST['gen'])){
									if($dato->createEnte()){
											...
											Page::showMessage(1, "Se ha insertado correctamente se continuara con selecion de productos" , "p3reserva_nueva.php?cliente=$id_cliente");
									}else{
...
require_once("../../../app/views/dashboard/hotel/reservas/p2o1reserva_nueva_view.php");
?>