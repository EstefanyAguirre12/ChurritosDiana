<!-- page content -->
      <div class="right_col" role="main" class="estilo_righ">
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Mantenimiento de Eventos</h3>
            </div>
          </div>
                      ...
                      <form method='post'>
                        <div class="col-sm-6">
                          <div id="datatable-checkbox_filter" class="dataTables_filter">
                            <label>Busquedad:
                              <input type="search" name="busqueda" class="form-control input-sm validate" placeholder="Nombre/Capacidad" aria-controls="datatable-checkbox" /required>
                            </label>
                        ...
                        <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                          <thead>
                            <tr role="row">
                              ...
                              <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Costo</th>
                              ...
                              foreach($data as $row){
                                print("
                                  <tr role='row' class='odd'>
                                    ...
                                    <td>$row[Costo]</td>
                                    <td>
                                      <a href='modificarsala.php?id=$row[IdSala]' type='button' class='btn btn-round btn-info'>
                                        <i class='far fa-edit'></i>
                                      </a>
                                    </td>
                                    <td>
                                      <a href='eliminarsala.php?id=$row[IdSala]' type='button' class='btn btn-round btn-danger'>
        ...
        ?>
            <li class="page-item"><a class="page-link" href="indexsala.php?page=1">Primera</a></li>
            <li class="page-item"><a class="page-link" href="indexsala.php?page=<?php echo $link_prev;?>">&laquo;</a></li>
        <?php
        }
        ?>
        ...
        for($i = $inicio_numero; $i <= $fin_numero; $i++)
        {
            ...
            <li class="page-item <?php echo $link_activo;?>"><a class="page-link" href="indexsala.php?page=<?php echo $i;?>"><?php echo $i?></a></li>
            <?php
        }
        ...
        }else
        {
            ...
            ?>
            <li class="page-item"><a class="page-link" href="indexsala.php?page=<?php echo $link_activo;?>">&raquo;</a></li>
            <li class="page-item"><a class="page-link" href="indexsala.php?page=<?php echo $numero_pag?>">Ultima</a></li>
            <?php
        }
        ?>
    </ul>
                    ...
                    <div class="text-right">
                      <a href="agregarsala.php" type="submit" class="btn btn-success">Agregar</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="middle-name  " name="capacidad1" class="form-control col-md-7 col-xs-12 validate" type="text" name="middle-name" required/>
                  </div>
                </div>
                <div class="form-group">
                  <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Capacidad1 final*:</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="middle-name  " name="capacidad2" class="form-control col-md-7 col-xs-12 validate" type="text" name="middle-name" required/>
                  </div>
                </div>
