                ...
                <div class="x_content">
                  <form method="post"  autocomplete= 'off' id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="middle-name" name="cos" class="form-control col-md-7 col-xs-12 validate" type="text" name="middle-name" value="<?php print($dato->getCosto()) ?>" required/>
                      </div>
                    </div>
                    <div class="ln_solid"></div>
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      <a href="indexsala.php" class="btn btn-primary" type="button">Cancelar</a>
