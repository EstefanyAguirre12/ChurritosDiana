                  ...
                  <div id="datatable-checkbox_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                      ...
                      <form autocomplete= 'off' method='post'>
                        <div class="col-sm-6">
                          <div id="datatable-checkbox_filter" class="dataTables_filter">
                            <label>Busquedad:
                              <input type="search" name="busqueda" class="form-control input-sm validate" placeholder="Numero/Capacidad" aria-controls="datatable-checkbox" /required>
                            </label>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                          <thead>
                            <tr role="row">
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Numero Mesa</th>
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Capacidad</th>
                              ...
                              foreach($data as $row){
                                print("
                                  <tr role='row' class='odd'>
                                    ...
                                    <td>$row[Cantidad]</td>
                                    <td>
                                      <a href='modificarsilla.php?id=$row[IdSilla]' type='button' class='btn btn-round btn-info'>
                                        <i class='far fa-edit'></i>
                                      </a>
                                    </td>
                                    <td>
                                      <a href='eliminarsilla.php?id=$row[IdSilla]' type='button' class='btn btn-round btn-danger'>
                    ...
                    <div class="row">
                      ...
                      <ul class="pagination justify-content-center">
                          ...
                          ?>
                              <li class="page-item"><a class="page-link" href="indexsilla.php?page=1">Primera</a></li>
                              <li class="page-item"><a class="page-link" href="indexsilla.php?page=<?php echo $link_prev;?>">&laquo;</a></li>
                          <?php
                          }
                          ?>
                          ...
                          for($i = $inicio_numero; $i <= $fin_numero; $i++)
                          {
                              ...
                              <li class="page-item <?php echo $link_activo;?>"><a class="page-link" href="indexmesa.php?page=<?php echo $i;?>"><?php echo $i?></a></li>
                              <?php
                          }
                          ...
                          }else
                          {
                              ...
                              ?>
                              <li class="page-item"><a class="page-link" href="indemesa.php?page=<?php echo $link_activo;?>">&raquo;</a></li>
                              <li class="page-item"><a class="page-link" href="indexmesa.php?page=<?php echo $numero_pag?>">Ultima</a></li>
                              <?php
                          }
                          ?>
                      </ul>
                    ...
                    <div class="text-right">
                      <a href="agregarsilla.php" type="submit" class="btn btn-success">Agregar</a>
                    </div>
                  </div>
                </div>
              </div>
