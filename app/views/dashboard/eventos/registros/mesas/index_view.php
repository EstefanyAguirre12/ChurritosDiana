                        ...
                        <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                          <thead>
                            <tr role="row">
                              ...
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Cantidad</th>
                              ...
                              foreach($data as $row){
                                print("
                                  <tr role='row' class='odd'>
                                    ...
                                    <td>$row[Cantidad]</td>
                                    <td>
                                      <a href='modificarmesa.php?id=$row[IdMesa]' type='button' class='btn btn-round btn-info'>
                                        <i class='far fa-edit'></i>
                                      </a>
                                    </td>
                                    <td>
                                      <a href='eliminarmesa.php?id=$row[IdMesa]' type='button' class='btn btn-round btn-danger'>
