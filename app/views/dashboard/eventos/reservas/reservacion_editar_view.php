                  ...
                  <form   method="post" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left"> 
                    <br>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <input type="number" value="<?php print($dato->getCantidadm()) ?>"  name ="cantidadM" class="form-control has-feedback-left" id="inputSuccess2" placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <input type="number" value="<?php print($dato->getCantidads()) ?>" name ="cantidadS" class="form-control has-feedback-left" id="inputSuccess2" placeholder="">
                        </div>
                      </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <input type="date" value="<?php print($dato->getFecha()) ?>" name ="fecha" class="form-control has-feedback-left"  placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <input type="time" value="<?php print($dato->getHorain()) ?>" name ="hinicio" class="form-control has-feedback-left"  placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <input type="time" value="<?php print($dato->getHorafi()) ?>" name ="hfin" class="form-control has-feedback-left"  placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <button type="submit" name="modificar" class="btn btn-success">Aceptar</button>
                      </div>
                    </div>
                  </form>
                </div>
