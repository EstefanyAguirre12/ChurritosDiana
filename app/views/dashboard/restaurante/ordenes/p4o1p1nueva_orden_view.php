                                        ...
                                        <h3>Precio: $ <?php print($nueva_orden->getpprecio()) ?></h3>
                                            <div class='form-group'>
                                              ...
                                              <div class='col-md-6 col-sm-6 col-xs-12'>
                                                <input id='middle-name' name='cantidad' validate class='form-control col-md-7 col-xs-12 validate' type='numeric' name='middle-name' value='<?php print($nueva_orden->getCantidad()) ?>' required/>
                                                 </div>
                                            </div>
