                ...
                <div class="x_content">
                  <div id="datatable-checkbox_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                              ...
                              foreach($data as $row){
                                print("
                                  <tr role='row' class='odd'>
                                    ...
                                    <td>$row[Capacidad]</td>
                                    <td>
                                      <a href='modificarmesa.php?id=$row[IdMesaRes]' type='button' class='btn btn-round btn-info'>
                                        <i class='far fa-edit'></i>
                                      </a>
                                    </td>
                                    <td>
                                      <a href='eliminarmesa.php?id=$row[IdMesaRes]' type='button' class='btn btn-round btn-danger'>
                      ...
                      <div class="col-sm-7">
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center">
                              ...
                              ?>
                                  <li class="page-item"><a class="page-link" href="indexmesa.php?page=1">Primera</a></li>
                                  <li class="page-item"><a class="page-link" href="indexmesa.php?page=<?php echo $link_prev;?>">&laquo;</a></li>
                              <?php
                              }
                              ?>
                              ...
                              }else
                              {
                                  ...
                                  ?>
                                  <li class="page-item"><a class="page-link" href="indexmesa.php?page=<?php echo $link_activo;?>">&raquo;</a></li>
                    ...
                    <div class="text-right">
                      <a href="agregarmesa.php" type="submit" class="btn btn-success">Agregar</a>
                    </div>
                  </div>
                </div>
              </div>
