                ...
                <div class="x_content">
                  <div id="datatable-checkbox_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                      ...
                      <form method='post'>
                        <div class="col-sm-6">
                          <div id="datatable-checkbox_filter" class="dataTables_filter">
                            <label>Busquedad:
                              <input type="search" name="busqueda" class="form-control input-sm validate" placeholder="Categoria" aria-controls="datatable-checkbox" /required>
                            </label>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                          <thead>
                            <tr role="row">
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Categoria</th>
                              ...
                              foreach($data as $row){
                                print("
                                  <tr role='row' class='odd'>
                                    <td>$row[Categoria]</td>
                                    <td>
                                      <a href='modificarcategoria.php?id=$row[IdCategoria]' type='button' class='btn btn-round btn-info'>
                                        <i class='far fa-edit'></i>
                                      </a>
                                    </td>
                                    <td>
                                      <a href='eliminarcategoria.php?id=$row[IdCategoria]' type='button' class='btn btn-round btn-danger'>
                                        <i class='far fa-trash-alt'></i>
                                      </a>
                                    </td>
                                    <td>
                                       <a href='reporte_lavanderiaC.php?idcategoria=$row[IdCategoria]' target='_blank' type='button' class='btn btn-round btn btn-success'>
                      ...
                      <div class="col-sm-7">
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center">
                              ...
                              ?>
                                  <li class="page-item"><a class="page-link" href="indexcategoria.php?page=1">Primera</a></li>
                                  <li class="page-item"><a class="page-link" href="indexcategoria.php?page=<?php echo $link_prev;?>">&laquo;</a></li>
                              <?php
                              }
                              ?>
                              ...
                              $cuenta = $dato->countCategorialavanderia();
                              ...
                              for($i = $inicio_numero; $i <= $fin_numero; $i++)
                              {
                                  ...
                                  <li class="page-item <?php echo $link_activo;?>"><a class="page-link" href="indexcategoria.php?page=<?php echo $i;?>"><?php echo $i?></a></li>
                                  <?php
                              }
                              ...
                              }else
                              {
                                  ...
                                  ?>
                                  <li class="page-item"><a class="page-link" href="indexcategoria.php?page=<?php echo $link_activo;?>">&raquo;</a></li>
                                  <li class="page-item"><a class="page-link" href="indexcategoria.php?page=<?php echo $numero_pag?>">Ultima</a></li>
                                  <?php
                              }
                              ?>
                          </ul>
                    ...
                    <div class="text-right">
                      <a href="agregarcategoria.php" type="submit" class="btn btn-success">Agregar</a>
                    </div>
                  </div>
                </div>
              </div>
