            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel"> 
                  <div class="x_content">
                    ...
                    <div class="">
                          <a href="p2o1reserva_nueva.php" class=" buttonDisabled btn btn-primary">Anterior</a>
                    </div>
                    <!-- Tabs -->
                        ...
                        <div class="animated lipInY col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              <div class="tile-stats">
                                ...
                                <h3>se crea nueva cuenta de pago.</h3>
                                    ...
                                    <?php
                                        print("
                                            <a href='p3o1reserva_nueva.php?cliente=$id_cliente' class='btn btn-info btn-lg'>Selecionar</a>
                                        ");
                                      ?>
                                    </div>
                              </div>
                            ...
                            <div class="animated lipInY col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              <div class="tile-stats">
                                ...
                                <h3>Los cargos seran agregador a la cuenta total.</h3>
                                    ...
                                    <?php
                                        print("
                                            <a href='p3o2reserva_nueva.php?cliente=$id_cliente' class='btn btn-info btn-lg'>Selecionar</a>
                                        ");
                                      ?>
                                    </div>
                              </div>
