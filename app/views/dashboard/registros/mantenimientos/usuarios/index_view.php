                ...
                <div class="x_content">
                  <div id="datatable-checkbox_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                      ...
                      <form autocomplete= 'off' method='post'>
                        <div class="col-sm-6">
                          <div id="datatable-checkbox_filter" class="dataTables_filter">
                            <label>Busquedad:
                              <input type="search" name="busqueda" class="form-control input-sm validate" placeholder="Usuario/Empleado" aria-controls="datatable-checkbox" /required>
                            </label>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                          <thead>
                            <tr role="row">
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Usuario</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Nombre</th>
                              ...
                              foreach($data as $row){
                                print("
                                  <tr role='row' class='odd'>
                                    ...
                                    <td>
                                      <a href='modificarusuarios.php?id=$row[IdUsuario]' type='button' class='btn btn-round btn-info'>
                                        <i class='far fa-edit'></i>
                                      </a>
                                    </td>
                                    <td>
                                      <a href='eliminarusuarios.php?id=$row[IdUsuario]' type='button' class='btn btn-round btn-danger'>
                    ...
                    <div class="row">
                      ...
                      <ul class="pagination justify-content-center">
                          ...
                          for($i = $inicio_numero; $i <= $fin_numero; $i++)
                          {
                              ...
                              <li class="page-item <?php echo $link_activo;?>"><a class="page-link" href="indexusuarios.php?page=<?php echo $i;?>"><?php echo $i?></a></li>
                              <?php
                          }
                    ...
                    <div class="text-right">
                      <a href="agregarusuarios.php" type="submit" class="btn btn-success">Agregar</a>
                    </div>
                  </div>
                </div>
              </div>
