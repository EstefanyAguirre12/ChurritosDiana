                      ...
                      <div class="col-sm-7">
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center">
                              ...
                              ?>
                                  <li class="page-item"><a class="page-link" href="indextipoente.php?page=1">Primera</a></li>
                                  <li class="page-item"><a class="page-link" href="indextipoente.php?page=<?php echo $link_prev;?>">&laquo;</a></li>
                              <?php
                              }
                              ?>
                              ...
                              for($i = $inicio_numero; $i <= $fin_numero; $i++)
                              {
                                  ...
                                  <li class="page-item <?php echo $link_activo;?>"><a class="page-link" href="indextipoente.php?page=<?php echo $i;?>"><?php echo $i?></a></li>
                                  <?php
                              }
